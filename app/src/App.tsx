...
const navItems = ['About', 'Publications', 'Contact'];
  ...
  return (
    <Box sx={{ display: 'flex', backgroundColor: '#1A1A1A', color: 'white' }}>
      ...
      <Box component="main" sx={{ p: 3}}>
        <Toolbar />
        <Box id="csec" sx={{ minHeight: '100vh' }}>
          <Typography variant="h4">For CSEC members</Typography>
          <Typography>
            We plan to release our novel attack tool to reproduce our attack, named Breaktooth, at the end of August 2024.
          </Typography>
        </Box>
        {/* <Box id="about" sx={{ minHeight: '100vh' }}>
          <Typography variant="h4">About</Typography>
          <Typography>
            For CSEC members, we will release our novel attack tool to reproduce our attack, named Breaktooth.
          </Typography>
        </Box>
        <Box id="publications" sx={{ minHeight: '100vh' }}>
